...
tf.app.flags.DEFINE_integer('num_labeled_examples', 50000, "The number of labeled examples")
...
def prepare_dataset():
    ...
    convert_images_and_labels(_train_images, _train_labels,
                              os.path.join(dirpath, 'cifar10_sup_labeled_train.tfrecords'))
    convert_images_and_labels(test_images,
                              test_labels,
                              os.path.join(dirpath, 'cifar10_sup_test.tfrecords'))
...
def one_transformed_input(batch_size=100,
    ...
    if train:
        filenames = ['cifar10_sup_labeled_train.tfrecords']
        num_examples = FLAGS.num_labeled_examples
    else:
        filenames = ['cifar10_sup_test.tfrecords']
